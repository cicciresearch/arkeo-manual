...
<figure markdown="span">
  <img src="../../assets/img/software/multi-led-control.png" alt="MultiLED Control" width="800">
</figure>
...
In addition to the manual control, the light can accept any custom waveform as output. Users can pregenerate an output sequence, upload it to microcontroller and run it in the background. This is useful for day-night analysis, light cycling or light-dependent performance.